...
describe("default server stores", () => {
  ...
  test.each([
    ...
    ["sarathi.json", { schemaVersion: 8, dashboard: {} }],
    ...
    expect(() => createDefaultStoreTestApp(manager())).toThrow(fileName === "sarathi.json" ? "schema version 8 is newer than supported version 7" : "schema version 2 is newer than supported version 1");
