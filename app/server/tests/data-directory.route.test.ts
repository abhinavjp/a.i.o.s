...
describe("default server stores", () => {
  ...
  test.each([
    ...
    ["sarathi.json", { schemaVersion: 6, dashboard: {} }],
    ...
    expect(() => createDefaultStoreTestApp(manager())).toThrow(fileName === "sarathi.json" ? "schema version 6 is newer than supported version 5" : "schema version 2 is newer than supported version 1");
