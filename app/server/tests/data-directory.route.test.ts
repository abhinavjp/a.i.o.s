...
describe("default server stores", () => {
  ...
  test.each([
    ...
    ["sarathi.json", { schemaVersion: 7, dashboard: {} }],
    ...
    expect(() => createDefaultStoreTestApp(manager())).toThrow(fileName === "sarathi.json" ? "schema version 7 is newer than supported version 6" : "schema version 2 is newer than supported version 1");
