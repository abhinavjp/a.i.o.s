...
export interface ArtifactStore { list(workItemId: string, stageKind?: StageKind): ArtifactReference[]; get(id: string): ArtifactReference | undefined; save(artifact: ArtifactReference): void; }
