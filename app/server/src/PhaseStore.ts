...
export interface PhaseStore { list(workItemId: string): StoredPhase[]; create(input: StoredPhase): void; addTask(workItemId: string, phaseNumber: number, taskId: string): void; }
