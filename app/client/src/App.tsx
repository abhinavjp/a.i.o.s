...
export function App() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const next = (await response.json()) as { taskId?: string; error?: string; resolvedEnginePlan?: ResolvedEnginePlan; readiness?: EngineReadiness; outcome?: TaskOutcome };
    ...
    const { taskId } = next;
    setAdmission({ plan: next.resolvedEnginePlan, readiness: next.readiness, outcome: next.outcome });
    void refreshDashboard();
